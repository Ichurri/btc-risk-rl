"""Export small P1 evidence from campaign logs only; no OHLC, optimizer or evaluation."""
...
from btc_risk_rl.pilots.p1_protocol import CAMPAIGN, PROTOCOL_SHA, entries
...
def main():
    ...
    for index, entry in enumerate(entries()):
        seed, condition, run_id = entry["seed"], entry["condition"], entry["run_id"]
    ...
    result = dict(
        ...
        interpretation="P1 technical pilot only; two iterations do not show convergence or population CVaR compliance",
